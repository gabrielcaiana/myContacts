<template>
  <v-row justify="center">
    <v-dialog transition="dialog-bottom-transition" :value="dialog">
      <v-card class="profile">
        <v-toolbar dark color="primary">
          <div class="profile__header">
            <v-toolbar-title> Cadastrar novo contato </v-toolbar-title>
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      this.$store.dispatch('contacts/registerContact', params);
      this.$emit('close');
    },
  },
};
